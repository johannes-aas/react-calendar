...
export const eventCategories: Record<string, EventCategoryConfig> = {
  ...
  course: {
    ...
    classes: {
      ...
      card: "bg-red-100 text-red-950 border-red-200 hover:border-red-300 dark:bg-red-950 dark:text-red-50 dark:border-red-900 dark:hover:border-red-800",
  ...
  networking: {
    ...
    classes: {
      ...
      card: "bg-green-100 text-green-950 border-green-200 hover:border-green-300 dark:bg-green-950 dark:text-green-50 dark:border-green-900 dark:hover:border-green-800",
  ...
  digital: {
    ...
    classes: {
      ...
      card: "bg-yellow-100 text-yellow-950 border-yellow-200 hover:border-yellow-300 dark:bg-yellow-950 dark:text-yellow-50 dark:border-yellow-900 dark:hover:border-yellow-800",
