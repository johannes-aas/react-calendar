...
const DEFAULT_STYLES = {
  itemBg: "bg-gray-100 dark:bg-neutral-800",
  itemBgGradientFade: "to-gray-100 dark:to-neutral-800",
  itemText: "text-gray-500 dark:text-neutral-300",
  cardBg: "bg-gray-100 dark:bg-neutral-700 border-gray-200 dark:border-neutral-600",
  cardText: "text-gray-900 dark:text-gray-100",
  cardBorderHover: "hover:border-gray-400 dark:hover:border-neutral-500",
}
